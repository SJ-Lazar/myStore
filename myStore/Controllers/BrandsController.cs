...
namespace myStore.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BrandId,BrandName,BrandLogoPath")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BrandId,BrandName,BrandLogoPath")] Brand brand)
        {
            if (id != brand.BrandId)
            {
                return NotFound();
